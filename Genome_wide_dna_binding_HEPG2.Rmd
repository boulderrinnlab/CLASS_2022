...
```{r creating promoter and gene body annotations}
...
rtracklayer::export(lncrna_promoters, "results/mRNA_promoters.gtf")
...
rtracklayer::export(lncrna_mrna_genebody, "results/lncrna_genebody.gtf")
...
rtracklayer::export(lncrna_mrna_genebody, "results/mrna_genebody.gtf")

```


```{r DBP CHIP peaks overlap with promoters and genebodys }
...
# using count peaks per feature returns number of annotation overlaps for a given DBP
