...
# one DBP only binds 26 of the 5,663 high binder promoters

ncol(high_binders)
# the DBP with lowest promoter overlaps - has 26 overlaps with promoters.
...
# TODO this doesn't run and get's join error
