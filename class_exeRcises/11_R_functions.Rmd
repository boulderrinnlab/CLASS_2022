...
Here we will use the peak_list we generated above and push it into this function to find overlaps.
```{r}
...
Ok let's go through the code that is a function of functions.
```{r}
