...
# Running consensus peaks function (CAREFUL this take a long time!)
```{r run consensus peaks *WARNING TAKES 3HRS*}
...
between replicates.
```{r exporting consensus_peaks}

# we use a for loop to export each GRange item in consensus_peaks
# to a .bed file.
...
# Voila we have a single consensus peak file for each DBP
# We will use these alot moving forward.
