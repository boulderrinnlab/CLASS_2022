...
hist(width(consensus_peaks[[2]]), breaks = 100)
...
names(filtered_consensus_peaks) <- gsub("/scratch/Shares/rinnclass/CLASS_2022/data/consensus_peaks/|_filtered_consensus_peaks.bed", "", filtered_consensus_peaks_files)
...
# note we need to add names!

# TODO how to put in names for promoters and lncRNAs
names(lncrna_mrna_promoters) <- gsub("/scratch/Shares/rinnclass/CLASS_2022/data/filtered_consensus_peaks/|_filtered_consensus_peaks.bed", "", filtered_consensus_peaks_files)
...
# TODO how to put in names for promoters and lncRNAs (gene name is in there)
