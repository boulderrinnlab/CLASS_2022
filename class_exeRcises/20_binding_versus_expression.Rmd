...
# TODO rerun with gene_id in both.

hepg2_df <- promoter_features_df %>%
  dplyr::select(gene_id, tpm_total, tpm_cytosolic_fraction, tpm_nuclear_fraction, tpm_insoluble_cytoplasmic_fraction, tpm_membrane_fraction, number_of_dbp) %>%
   dplyr::rename(hepg2_tpm_total = tpm_total,
                 hepg2_tpm_cytosolic_fraction = tpm_cytosolic_fraction,
                 hepg2_tpm_nuclear_fraction = tpm_nuclear_fraction,
                 hepg2_tpm_insoluble_cytoplasmic_fraction = tpm_insoluble_cytoplasmic_fraction,
                 hepg2_tpm_membrane_fraction = tpm_membrane_fraction,
                 hepg2_number_of_dbp = number_of_dbp)
