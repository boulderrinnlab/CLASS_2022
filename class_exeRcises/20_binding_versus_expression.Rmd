...
# The PCA plot in results showed us ENCODE had a label swapped.
# Now we are fixing that to add the right labels after manual inspection
...
write_csv(samplesheet, "/Shares/rinn_class/data/CLASS_2022/class_exeRcises/analysis/20_binding_vs_expression/results/samplesheet_fixed_condition.csv")
```
...
# missing need to rerun pipeline

salmon_tpm <- read.csv("/scratch/Shares/rinnclass/CLASS_2022/JR/rnaseq/results/salmon/salmon_merged_transcript_tpm.csv")
