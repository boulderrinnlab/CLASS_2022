...
Next we will determine if the linear correlation of DBP binding to abundance
holds across all the fractionation data.
```{r}

#TODO
# Now plot this for each subcellular fraction

# SOMETHING LIKE BELOW but with a facet for each fraction?
...
# TODO START HERE but found the DF -- thank goodness that was hard ::)

k562_df <- read_csv("/scratch/Shares/rinnclass/CLASS_2022/data/2020_peak_occurence_df.csv")
