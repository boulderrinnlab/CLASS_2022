...
# note simply changes file path and cp recreates the entire directoy.
...
Let's download and play with the encode .TSV file. This is a file of ENCODE data we will learn more about soon. For now just think of it as a file

[Download here](https://www.dropbox.com/s/ij798is442fyt3h/encode_awk_lessons.tsv?dl=0)

Transfer this file to a directory and navigate there with your terminal.
...
*Note you have changed the encode_awk_lessons.tsv file forever -- there is no undo in bash 
```
