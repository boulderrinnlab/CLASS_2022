...
filtered_consensus_peaks_files <- list.files("/scratch/Shares/rinnclass/CLASS_2022/<your_folder>/CLASS_2022/class_exeRcises/analysis/11_consensus_peaks/consensus_peaks", 
                                             pattern = "*.bed",
                                             full.names = TRUE)

# filtered_consensus_peaks_files <- list.files("/scratch/Shares/rinnclass/CLASS_2022/JR/CLASS_2022/class_exeRcises/analysis/11_consensus_peaks/consensus_peaks", 
   #                                         pattern = "*.bed",
    #                                       full.names = TRUE)
...
names(filtered_consensus_peaks) <- gsub("/scratch/Shares/rinnclass/CLASS_2022/JR/CLASS_2022/class_exeRcises/analysis/11_consensus_peaks/filtered_consensus_peaks/|_consensus_peaks.bed", "", filtered_consensus_peaks)
