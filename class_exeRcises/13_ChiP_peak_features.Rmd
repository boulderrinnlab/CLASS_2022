...
write_csv(num_peaks_df, "/Shares/rinn_class/data/CLASS_2022/class_exeRcises/analysis/13_ChIP_peak_features/num_peaks_df.csv")
...
Cool all 460 are in there so let's merge the tables
```{R}
...
write.table(promoter_peak_occurence, "/Shares/rinn_class/data/CLASS_2022/class_exeRcises/analysis/13_ChIP_peak_features/lncrna_mrna_promoter_peak_occurence_matrix.tsv")
...
write_csv(peak_occurence_df, "/Shares/rinn_class/data/CLASS_2022/class_exeRcises/analysis/13_ChIP_peak_features/peak_occurence_dataframe.csv")
...
2) Which non TF has the most peaks and genome coverage. How does it compare to those that are TFs
