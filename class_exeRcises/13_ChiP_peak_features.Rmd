...
# first create a file list of filtered consensus peaks
 filtered_consensus_peaks_files <- list.files("/scratch/Shares/rinnclass/CLASS_2022/Your_folder/CLASS_2022/class_exeRcises/analysis/11_consensus_peaks/filtered_consensus_peaks", 
                                             pattern = "*.bed",
                                             full.names = TRUE)
