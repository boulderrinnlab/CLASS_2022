...
fl <- list.files("/scratch/Shares/rinnclass/CLASS_2022/data/consensus_peaks", full.names = TRUE)
...
names(filtered_consensus_peaks) <- gsub("/scratch/Shares/rinnclass/CLASS_2022/data/consensus_peaks/|.bed", "", fl)
...
```{r test importing filtered consensus peaks to start}
...
# write.table(metaplot_df, "test_metaplot_df.tsv")

# test_meta_plot_df <- read.table("test_metaplot_df.tsv")
...
# Let's see what we lost:
#TODO figure out way to extract those with NA.
