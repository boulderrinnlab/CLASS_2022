...
=======
>>>>>>> e489f18b7b26e85ef33d00549e0ce9fddfd2be9d
```{r}
...
# ggplot(num_peaks_df, aes(x = num_peaks, y = total_peak_length)) +
  # geom_point() +
  # geom_abline(slope = lm_fit$coefficients[[1]], intercept = lm_fit$coefficients[[2]])
=======
lm_fit <- lm(num_peaks_df$num_peaks ~ num_peaks_df$total_peak_length)
# is equivalent to
geom_smooth(method = "lm")

geom_abline(slope = lm_fit$coefficients[[2]], intercept = lm_fit$coefficients[[1]])
>>>>>>> e489f18b7b26e85ef33d00549e0ce9fddfd2be9d
```
