...
rlog_counts_matrix_nuc_cyt <- round(rlog_counts_matrix_nuc_cyto)
...
rld_pca <- prcomp(t(assay(rlog_counts_matrix)))
...
# TODO why does rlog counts have negative numbers?
dds <- DESeqDataSetFromMatrix(countData = rlog_counts_matrix_nuc_cyto,
                              colData = samplesheet_filtered_nuc_cyto,
                              design = ~ condition)
