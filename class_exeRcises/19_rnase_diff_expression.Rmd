...
We are almost ready, just a few more things to double check For example, that the sample sheet and the counts are in right order. Moreover, DeSeq2 requires integers and that condition is a factor.
