...
# Right now the samples are named with the sample id
# but in the samplesheet there is a much more interpretable name
# Let's put the counts columns in the same order as the samplesheet
...
counts <- counts[, samplesheet_filtered$sample_name]
