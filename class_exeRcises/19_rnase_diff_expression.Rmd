...
# (4) now we retrieve the values using assay (an access function into rlog_counts)
...
# we can also look at this with summary
summary(num_sig)

# We see about 15,000 genes exhibit differential expressed.
```
