...
Now let's go find the widths associated with gene-length. Note difference between a DF and Ranges(GRanges)
```{R}
...
Let's see how many peaks there were and how many overlapped promoters in total
...
# To find the number of peaks that overlap (note many overlap > 1 promoter)
...
# Let's look at this in a different way with table
